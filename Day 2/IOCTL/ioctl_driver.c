...
2. If we register IOCTl call in fops with â€œ.unlocked_ioctl = my_ioctl,â€ then it will work as concurrent function/without kernel lock.
*/
static long ts_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
         switch(cmd) {
